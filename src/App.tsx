...
import codecrafterLogo from './sponsors/Bronze/codecrafter.png';
import laaLogo from './sponsors/Bronze/laa.png';
...
function App() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: 'Yes, meals and snacks will be provided free of cost. We will accommodate any food sensitivities to the best of our ability.',
    },
    {
      question: 'Do I need a team to participate?',
      answer:
        "You don't need to be in a team to participate in MasseyHacks! It's up to you whether you choose to fly solo or group up with your friends. And who knows: you might meet some cool new people during the event!",
    },
    { question: 'Who can participate?', answer: 'MasseyHacks welcomes students from grades 7-12.' },
    {
      ...
      answer:
        "Not at all! At MasseyHacks, we'll teach you the fundamentals you need to know to make your project through beginner workshops and mentors who will assist you if you ever need any help.",
    },
    { question: 'How many people can I have on my team?', answer: 'You can have as many as 4 people per team!' },
    {
      question: 'Where is MasseyHacks being held?',
      answer: 'MasseyHacks will be held at Vincent Massey Secondary School at 1800 Liberty St, Windsor, ON.',
    },
    {
    ...
    {
      question: 'What activities and workshops will be hosted at MasseyHacks?',
      answer: 'You can find the schedule on our website (coming soon).',
    },
    {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => setLogoPopped(true), 3000);
          ...
          <div className="px-4 py-4 bg-cyan-500/10 backdrop-blur-md flex flex-col gap-3">
            {['about', 'gallery', 'schedule', 'faq', 'sponsors'].map((section) => (
              <a
                ...
                className="text-white hover:text-cyan-200 transition-colors font-semibold drop-shadow-md text-base py-2 hover:bg-white/10 px-3 rounded-lg capitalize"
            ...
            <div className={`logo-content transition-all duration-1000 ${logoPopped ? 'opacity-100 scale-100' : 'opacity-0 scale-0'} w-full`}>
              ...
              <div className="bg-cyan-500/10 backdrop-blur-md rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-10 border border-white/30 mb-4 sm:mb-6 shadow-2xl w-full" data-testid="countdown-section">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-6 sm:mt-8 justify-center items-center">
                  {[
                    { label: 'Hacker Application', icon: <Code className="w-5 h-5" />, msg: 'Hacker applications will open in March 2026!' },
                    { label: 'Mentor Application', icon: <GraduationCap className="w-5 h-5" />, msg: 'Mentor applications will open in March 2026!' },
                    { label: 'Volunteer Application', icon: <Users className="w-5 h-5" />, msg: 'Volunteer applications will open in March 2026!' },
                  ].map(({ label, icon, msg }) => (
                    <button
                      key={label}
                      onClick={() => alert(msg)}
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2 sm:gap-3">
                {[
                  ...
                  { href: '#gallery', label: 'Gallery', testid: 'footer-link-gallery' },
                  { href: '#schedule', label: 'Schedule', testid: 'footer-link-schedule' },
